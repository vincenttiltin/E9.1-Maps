...
public interface Map<K, V> extends Traversable<Entry<K, V>> {
     ...
     * @precondition The map contains an entry for key.
     ...
     *
     * @precondition None.
     * @postcondition All entries are removed from this map.
     */
    void clear();

    /**
     * Determine if a map contains an entry for the specified key.
     *
     * @param key the key to find in the map.
     * @return true if this map contains an entry for the specified key, false otherwise.
     * @precondition None.
     * @postcondition Returns true if this map contains an entry for the specified key, false otherwise.
     */
     ...
     *
     * @return true if this map contains no key-value entries, false otherwise.
     * @precondition None.
     * @postcondition Returns true if this map contains no key-value entries, false otherwise.
     */
    boolean isEmpty();
